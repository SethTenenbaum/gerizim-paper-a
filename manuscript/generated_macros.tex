% Generated macros -- 2026-05-03T22:04:50Z
...
\newcommand{\NOwtradDegWApp}{193}
\newcommand{\NOwtradDegWAp}{420}
\newcommand{\NOwtradDegWA}{791}
\newcommand{\owtradVertexAppEnrich}{1.25}
\newcommand{\owtradVertexAEnrich}{1.08}
\newcommand{\owtradDegWAppEnrich}{1.38}
\newcommand{\owtradDegWAEnrich}{1.13}
...
\newcommand{\zOwtradDegWApp}{4.58}
\newcommand{\zOwtradDegWA}{3.86}
...
\newcommand{\pOwtradDegWAp}{< 0.0001}
...
% --- analysis/unesco/tumulus_dome_evolution_raw_sweep.py
  ...
  \newcommand{\pEvoAppFisher}{0.0658}     % p-value, A++ Fisher exact (dome corpus)
...
% --- analysis/unesco/dome_geographic_concentration_test.py
  \newcommand{\geoNullDomeBootP}{0.5429}   % within-dome bootstrap p
  \newcommand{\geoNullDomeBootZ}{-0.00}    % within-dome bootstrap Z
  \newcommand{\geoNullDomeBootMean}{18.00}   % within-dome bootstrap mean A+
  \newcommand{\geoNullDomeRestrictedP}{0.0393}   % restricted-pool p
  \newcommand{\geoNullDomeRestrictedZ}{2.00}    % restricted-pool Z
  \newcommand{\geoNullDomeRestrictedMean}{11.64}   % restricted-pool mean A+
  \newcommand{\geoNullDomeRestrictedN}{897}   % restricted pool size
  \newcommand{\geoNullDomeRestrictedRate}{12.9}   % A+ base rate in restricted pool (%)
  \newcommand{\geoNullDomeRestrictedNtwo}{776}   % Null C ?2deg pool size
  \newcommand{\geoNullDomeRestrictedPtwo}{0.0257}   % Null C ?2deg p-value
  \newcommand{\geoNullDomeRestrictedMeantwo}{11.14}   % Null C ?2deg mean A+
  \newcommand{\geoNullDomeRestrictedNfive}{897}   % Null C ?5deg pool size
  \newcommand{\geoNullDomeRestrictedPfive}{0.0382}   % Null C ?5deg p-value
  \newcommand{\geoNullDomeRestrictedMeanfive}{11.65}   % Null C ?5deg mean A+
  \newcommand{\geoNullDomeRestrictedNten}{980}   % Null C ?10deg pool size
  \newcommand{\geoNullDomeRestrictedPten}{0.0442}   % Null C ?10deg p-value
  \newcommand{\geoNullDomeRestrictedMeanten}{11.84}   % Null C ?10deg mean A+
...
% --- analysis/unesco/fdr_multiple_comparisons.py
  ...
  \newcommand{\BonfAllSurviveclusterPermP}{0.0}  % full-k Bonferroni survivor
  \newcommand{\FDRqSurviveclusterPermP}{0.0}  % BH q-value survivor
