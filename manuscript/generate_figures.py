...
def _load_owtrad_edges():
    ...
    Datasets: tmcXMEm1400, tmcTRm1200a/b, tmcIRa0100, tmcZCAm0200/0600/0800/1000,
              tmcZMEm1300, tmcCNm1000, tmcKHm1200, tmcKGa0100d
...
def make_geo_trail():
    ...
    # Map extent: Mediterranean to Java, covering full Silk Road corridor
    ax.set_extent([-12, 145, -12, 58], crs=ccrs.PlateCarree())
...
if __name__ == "__main__":
    ...
    print("\nFigure 6 — OWTRAD Silk Road harmonic tiers (fig:owtrad_tiers)")
    import subprocess, sys
    subprocess.run([sys.executable, str(PROJECT_ROOT / "tools" / "owtrad_tier_analysis.py")],
                   check=True)
