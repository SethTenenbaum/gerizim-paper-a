...
def run():
    ...
    lines += [
        ...
        f"  {'A+':<6}  {tier_counts['A++']+tier_counts['A+']:>5}  {100*(tier_counts['A++']+tier_counts['A+'])/N:>5.1f}%  dev <= 0.002  beru  (~6.7 km from harmonic)",
        f"  {'A':<6}  {tier_counts['A++']+tier_counts['A+']+tier_counts['A']:>5}  {100*(tier_counts['A++']+tier_counts['A+']+tier_counts['A'])/N:>5.1f}%  dev <= 0.010  beru  (~33 km from harmonic)",
        f"  {'B':<6}  {tier_counts['B']:>5}  {100*tier_counts['B']/N:>5.1f}%  middle zone",
        f"  {'C':<6}  {tier_counts['C']+tier_counts['C-']+tier_counts['C--']:>5}  {100*(tier_counts['C']+tier_counts['C-']+tier_counts['C--'])/N:>5.1f}%  dist_mid <= 0.010 beru  (~33 km from midpoint)",
        f"  {'C-':<6}  {tier_counts['C-']+tier_counts['C--']:>5}  {100*(tier_counts['C-']+tier_counts['C--'])/N:>5.1f}%  dist_mid <= 0.002 beru  (~6.7 km from midpoint)",
