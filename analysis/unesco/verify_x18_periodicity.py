...
print(f"  \\newcommand{{\\optimalPhase}}{{{best_phase:.2f}}}")
print(f"  \\newcommand{{\\optimalPhaseAp}}{{{best_count}}}")
print(f"  \\newcommand{{\\GerizimPhase}}{{{GERIZIM % 3.0:.3f}}}")
print(f"  \\newcommand{{\\phaseGap}}{{{abs(GERIZIM % 3.0 - best_phase):.3f}}}")
print(f"  \\newcommand{{\\phaseGapKm}}{{{abs(GERIZIM % 3.0 - best_phase) * 111 * np.cos(np.radians(32)):.1f}}}")
