...
print("=" * 90)
print(f"  \\newcommand{{\\ZcochranThree}}{{{Z_ca:.2f}}}")
print(f"  \\newcommand{{\\pCochranThree}}{{{p_ca:.4f}}}")
print(f"  \\newcommand{{\\ZcochranFive}}{{{Z5:.2f}}}")
print(f"  \\newcommand{{\\pCochranFive}}{{{p_ca5:.4f}}}")
print(f"  \\newcommand{{\\rhoSpearman}}{{{rho2:.4f}}}")
print(f"  \\newcommand{{\\pSpearman}}{{{p_rho2:.6f}}}")
