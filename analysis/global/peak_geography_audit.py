...
print(f"  \\newcommand{{\\JerichoAnchorAp}}{{{count_ap_at_anchor(LANDMARKS['Jericho'])}}}")
print(f"  \\newcommand{{\\DeadSeaAnchorAp}}{{{count_ap_at_anchor(LANDMARKS['Dead Sea center'])}}}")
print(f"  \\newcommand{{\\MtNeboAnchorAp}}{{{count_ap_at_anchor(LANDMARKS['Mount Nebo'])}}}")
print(f"  \\newcommand{{\\DamascusAnchorAp}}{{{count_ap_at_anchor(LANDMARKS['Damascus'])}}}")
print(f"  \\newcommand{{\\localBestLon}}{{{local_max_lon:.3f}}}")
print(f"  \\newcommand{{\\localBestAp}}{{{local_max_ap}}}")
