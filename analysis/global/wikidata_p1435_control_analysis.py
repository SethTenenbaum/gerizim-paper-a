...
def main():
    ...
    print(f"  \\newcommand{{\\WDctrlN}}{{{n_c_fmt}}}")
    print(f"  \\newcommand{{\\WDctrlAp}}{{{k_c}}}")
    print(f"  \\newcommand{{\\WDctrlRate}}{{{r_c*100:.2f}}}")
    print(f"  \\newcommand{{\\WDctrlBinomP}}{{{p_binom_c:.2f}}}")
    print(f"  \\newcommand{{\\WDctrlOR}}{{{or_global:.2f}}}")
    print(f"  \\newcommand{{\\WDctrlORlo}}{{{or_lo:.2f}}}")
    print(f"  \\newcommand{{\\WDctrlORhi}}{{{or_hi:.2f}}}")
    print(f"  \\newcommand{{\\WDctrlZp}}{{{p_z:.4f}}}")
    print(f"  \\newcommand{{\\WDctrlPermP}}{{{p_perm:.3f}}}")
    print(f"  \\newcommand{{\\WDctrlMHOR}}{{{mh_or:.3f}}}")
    print(f"  \\newcommand{{\\WDctrlMHchi}}{{{mh_chi2:.3f}}}")
    print(f"  \\newcommand{{\\WDctrlMHp}}{{{mh_p:.4f}}}")
    print(f"  \\newcommand{{\\WDctrlDropEuropeOR}}{{{or_noeu:.2f}}}")
